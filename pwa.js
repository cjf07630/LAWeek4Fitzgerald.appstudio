...
const cacheName = 'LAWeek4Fitzgerald_appstudio-2021-02-24 15:51:03.440074'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LAWeek4Fitzgerald_appstudio'.length) === 'LAWeek4Fitzgerald_appstudio') {
